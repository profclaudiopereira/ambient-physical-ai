...
/**
 * @brief Applies the ambient lighting profile associated with an
 * authenticated identity.
 *
 * Unknown or absent identifiers intentionally fall back to the Visitor
 * profile so that the node always produces a deterministic and safe
 * expression.
 */
